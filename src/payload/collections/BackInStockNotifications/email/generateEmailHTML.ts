const generateEmailHTML = async ({ headline, content, imageUrl  }) => {
  ...
  return `
    ...
    <head>
      ...
      <title>Notification from Teck Heavens</title>
      <style>
        body {
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
        <img src="${imageUrl}" alt="${headline}" style="width: 200px; height: auto; margin-bottom: 10px;" />
          <h2>${headline}</h2>
          <p>${content}</p>
        </div>
